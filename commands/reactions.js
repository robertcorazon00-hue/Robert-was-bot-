    ...
    try {
        ...
        if (input === 'on') {
            ...
            await bug(
                ...
                `L'Auto-react est activÃ© *${input.toUpperCase()}*.`,
                3
            );
            ...
            await bug(
                ...
                `L'Auto-react est dÃ©sactivÃ©e *${input.toUpperCase()}*.`,
                3
            );
        ...
        await client.sendMessage(message.key.remoteJid, {
            ...
            text: `âŒ Error while updating autoreact settings: ${error.message}`,
        });
    }
}
