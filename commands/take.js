...
export async function take(client, message) {
    try {
        ...
        if (!quotedMessage || !quotedMessage.stickerMessage) {
            return client.sendMessage(remoteJid, { text: stylizedChar("âŒ Reply to a sticker to modify it!" )});
        }
        ...
        if (!stickerBuffer) {
            return client.sendMessage(remoteJid, { text: "âŒ Failed to download sticker!" });
        }
